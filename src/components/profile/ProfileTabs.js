    ...
    <>
      <section className={classes.section}>
        ...
        <Hidden xsDown>
          <Tabs
            value={value}
            // die underscore betekent dat je het eerste argument niet gebruikt
    ...
    <section className={classes.savedPostsSection}>
      <div className={classes.noContent}>
        ...
        <Typography align='center'>
          Save photos and videos you want to see again. No one is notified, and only you can see what you've saved.
        </Typography>
      </div>
    </section>
  )
